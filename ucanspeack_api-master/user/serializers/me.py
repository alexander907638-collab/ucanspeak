...
class UserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        read_only_fields = ['id', 'is_superuser', 'subscription_expire', 'is_school', 'last_lesson_url']
    ...
    def get_school(self, obj):
        ...
        if obj.is_school:
            school_obj = School.objects.get(admin=obj)
            serializer = SchoolSerializer(school_obj)
